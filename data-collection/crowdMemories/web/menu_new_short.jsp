...
<%
    //setting album_id, url e immagine
    ...
    <body>
        <div class="container">
            <div id="sfondo" class="hero-unit">
                <h1>Title</h1>   
                <div class="row" style="margin-left: 0px; background-color: white; text-align: center">
                    <div class="span7" style="margin-top: 20px;">
                        <h2><%= title%></h2> 
                    </div>
                    <div class="span4" style="padding: 10px;margin-left: 0px;">
                        <img id="image" src="<%= url%>" class="img-rounded"> 
                    </div>
                </div>

                <h1 style="margin-top: 30px;">Location</h1>
                <div class="row" style="margin-left: 0px; background-color: white; text-align: center">
                    <%
                        if (has_marker) {
                    %>
                ...
                <h1 style="margin-top: 30px;">Date</h1>
                <div class="row" style="margin-left: 0px; background-color: white; text-align: center">
            ...
            <div class="hero-unit" style="margin-top: 50px; width: 940px; margin-left: auto; margin-right: auto;text-align: center;"> 
