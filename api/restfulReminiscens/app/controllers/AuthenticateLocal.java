...
//					Field requestField = play.mvc.Http.Context.current().request().getClass().getDeclaredField("req$2");
//					play.api.mvc.Request requestInstance = (play.api.mvc.Request) requestField.get(play.mvc.Http.Context.current().request());
