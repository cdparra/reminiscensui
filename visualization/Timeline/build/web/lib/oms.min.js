...
*/
    ...
    if (((n = this.google) != i ? n.maps : void 0) != i) {
        ...
        z.removeMarker = function (b) { var c, a, e, d, f; b._omsData != i && this.unspiderfy(); c = this.m(this.a, b); if (0 > c) return this; e = this.j.splice(c, 1)[0]; d = 0; for (f = e.length; d < f; d++) a = e[d], r.removeListener(a); delete b._oms; this.a.splice(c, 1); return this }; z.clearMarkers = function () { var b, c, a, e, d, f, g, j; this.unspiderfy(); j = this.a; b = e = 0; for (f = j.length; e < f; b = ++e) { a = j[b]; c = this.j[b]; d = 0; for (g = c.length; d < g; d++) b = c[d], r.removeListener(b); delete a._oms } this.n(); return this }; z.addListener = function (b, c) {
            var a, e; ((e = (a = this.b)[b]) !=
            i ? e : a[b] = []).push(c); return this
        }; z.removeListener = function (b, c) { var a; a = this.m(this.b[b], c); 0 > a || this.b[b].splice(a, 1); return this }; z.clearListeners = function (b) { this.b[b] = []; return this }; z.trigger = function () { var b, c, a, e, d, f; c = arguments[0]; b = 2 <= arguments.length ? q.call(arguments, 1) : []; c = (a = this.b[c]) != i ? a : []; f = []; e = 0; for (d = c.length; e < d; e++) a = c[e], f.push(a.apply(i, b)); return f }; z.u = function (b, c) {
            var a, e, d, f, g; d = this.circleFootSeparation * (2 + b) / A; e = A / b; g = []; for (a = f = 0; 0 <= b ? f < b : f > b; a = 0 <= b ? ++f : --f) a = this.circleStartAngle +
            a * e, g.push(new u.Point(c.x + d * Math.cos(a), c.y + d * Math.sin(a))); return g
        }; z.v = function (b, c) { var a, e, d, f, g; d = this.spiralLengthStart; a = 0; g = []; for (e = f = 0; 0 <= b ? f < b : f > b; e = 0 <= b ? ++f : --f) a += this.spiralFootSeparation / d + 5E-4 * e, e = new u.Point(c.x + d * Math.cos(a), c.y + d * Math.sin(a)), d += A * this.spiralLengthFactor / a, g.push(e); return g }; z.F = function (b) {
            var c, a, e, d, f, g, j, l, k; d = b._omsData != i; (!d || !this.keepSpiderfied) && this.unspiderfy(); if (d || this.map.getStreetView().getVisible()) return this.trigger("click", b); d = []; f = []; c =
            this.nearbyDistance; g = c * c; e = this.c(b.position); k = this.a; j = 0; for (l = k.length; j < l; j++) c = k[j], c.map != i && c.getVisible() && (a = this.c(c.position), this.f(a, e) < g ? d.push({ A: c, p: a }) : f.push(c)); return 1 === d.length ? this.trigger("click", b) : this.G(d, f)
        }; z.willSpiderfy = function (b) {
            var c, a, e, d, f, g, j, l; if (this.e.getProjection() == i) throw "Must wait for 'idle' event on map before calling willSpiderfy"; a = this.nearbyDistance; e = a * a; a = this.c(b.position); g = this.a; d = 0; for (f = g.length; d < f; d++) if (c = g[d], !(c === b || c.map == i || !c.getVisible())) if (c =
            this.c((j = (l = c._omsData) != i ? l.l : void 0) != i ? j : c.position), this.f(c, a) < e) return h; return m
        }; z.markersThatWillAndWontSpiderfy = function () {
            var b, c, a, e, d, f, g, j, l, k, s, x; if (this.e.getProjection() == i) throw "Must wait for 'idle' event on map before calling markersThatWillAndWontSpiderfy"; f = this.nearbyDistance; b = f * f; e = this.a; f = []; k = 0; for (a = e.length; k < a; k++) c = e[k], f.push({ q: this.c((g = (j = c._omsData) != i ? j.l : void 0) != i ? g : c.position), d: m }); k = this.a; c = g = 0; for (j = k.length; g < j; c = ++g) if (a = k[c], a.map != i && a.getVisible() &&
            (e = f[c], !e.d)) { x = this.a; a = l = 0; for (s = x.length; l < s; a = ++l) if (d = x[a], a !== c && (d.map != i && d.getVisible()) && (d = f[a], (!(a < c) || d.d) && this.f(e.q, d.q) < b)) { e.d = d.d = h; break } } g = []; j = []; e = this.a; b = k = 0; for (a = e.length; k < a; b = ++k) c = e[b], (f[b].d ? g : j).push(c); return [g, j]
        }; z.z = function (b) {
            var c = this; return {
                h: function () { return b._omsData.i.setOptions({ strokeColor: c.legColors.highlighted[c.map.mapTypeId], zIndex: c.highlightedLegZIndex }) }, k: function () {
